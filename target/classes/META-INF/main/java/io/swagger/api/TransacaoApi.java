...
public interface TransacaoApi {
    ...
    @ApiOperation(value = "Altera o Valor da Transação", nickname = "alteraValorTransacao", notes = "Altera o valor da transação existente na conta do cliente.", response = Extrato.class, authorizations = {
        @Authorization(value = "BasicAuth")
    }, tags={ "Transacao", })
    @ApiResponses(value = { 
        @ApiResponse(code = 204, message = "Alteração do valor efetuada com sucesso.", response = Extrato.class),
    ...
    ResponseEntity<Extrato> alteraValorTransacao(@ApiParam(value = "",required=true) @PathVariable("codigo") Long codigo,@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "valor", required = true) Double valor,@ApiParam(value = "" ,required=true) @RequestHeader(value="Authorization", required=true) String authorization);
